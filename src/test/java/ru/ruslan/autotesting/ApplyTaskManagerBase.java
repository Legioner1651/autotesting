...
//    protected static final String ALIAS_CONTAINER_KAFKA = "kafkaAlias";
    ...
    protected static DockerComposeContainer composeKafka = new DockerComposeContainer<>(new File("docker-compose.yml"))
            .withEnv("TZ", localTimeZone.toString())
//            .withStartupTimeout(Duration.ofMinutes(5))
            .withExposedService("kafka-ui", 8080);
...
//        bootstrapServersKafka = composeKafka.getBootstrapServers();
...
//        }
//
//        log.info("environment containerKafka   = {}", containerKafka.getEnv());
//        log.info("environment containerKafkaUI = {}", containerKafkaUI.getEnv());
