...
//    protected static final String ALIAS_CONTAINER_KAFKA = "kafkaAlias";
    ...
    protected static KafkaContainer containerKafka = new KafkaContainer("apache/kafka-native:4.1.0")
            .withNetwork(network)
    ...
    protected static GenericContainer containerKafkaUI = new GenericContainer(KAFKA_UI_IMAGE)
            ...
            .withEnv("KAFKA_CLUSTERS_0_BOOTSTRAP_SERVERS", ALIAS_CONTAINER_KAFKA + ":9092")
